...
export default function WikiPageClient() {
  ...
  return (
    <div className="flex h-screen bg-white">
      {/* 좌측 네비게이션 */}
      <div className="w-80 border-r border-gray-200/70 flex flex-col bg-gray-50 shrink-0">
        <div className="px-5 py-4 border-b border-gray-100 bg-white">
          <div className="flex items-center justify-between mb-3">
            <span className="font-semibold tracking-tight text-gray-900 text-base">SNU 통합 위키</span>
          </div>
          <button
            onClick={() => router.back()}
            className="flex items-center justify-center gap-2 w-full py-2.5 rounded-md bg-blue-600 text-white text-sm font-medium shadow-sm hover:bg-blue-700 hover:shadow-md transition-all"
          >
