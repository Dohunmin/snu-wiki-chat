...
- **insight**: 사실을 *해석·판단·진단·제안·평가*하거나(특정 인물의 장단점·강점·약점·자질 평가 포함), **외부 정보**(외부 시선·여론·언론 언급·타 대학/기관 비교)가 필요한 질문. 자료로 답돼도 해석/판단/원인/제안/평가면 insight.
  예: "예산 늘릴 방안?", "~가능할까?", "종합대학 체계가 최선인가", "어떻게 개선해야 하나", "채용 어려운 이유/원인", "외부에서 서울대를 보는 시선·부정 언급", "인문대와 사회대 입장 차이", "○○ 후보/교수의 장단점·강점·약점".
  ⭐ 이유·원인·의미·의의를 묻는 건 "~는 무엇인가"로 끝나도 insight. **특정 인물의 장단점·평가·자질을 묻는 것도 insight**(단순 경력 나열만이면 fact). 외부 정보 필요시 insight. 애매하면 insight.
